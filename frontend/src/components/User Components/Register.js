...
const Register = () => {
    ...
    const handleSubmit = async () => {
        const roleId = isSpecialist ? '66659b79ca3cdb2fe0e92bc9' : '6664b711c97330a23805e283';
        try {
                ...
                <MDBCol lg='8'>
                    ...
                    <MDBCard className='my-5 rounded-3' style={{ maxWidth: '600px' }}>
                        ...
                        <MDBCardBody className='px-5'>
                            ...
                            <MDBInput  wrapperClass='mb-4' label='PhoneNumber' id='phoneNumber' type='text' onChange={(e)=>setPhoneNumber(e.target.value)}/>
